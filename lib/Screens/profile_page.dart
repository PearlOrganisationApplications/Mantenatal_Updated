              ...
              child: SingleChildScrollView(
                child: Column(
                  ...
                  children: <Widget>[
                    ...
                    //          text: "M",
                    //          style:
                    //              TextStyle(color: AppColors.skyColor, fontSize: 34),
                    //          children: <TextSpan>[
                    //            TextSpan(
                    //              text: "A",
                    //              style: TextStyle(
                    //                  color: AppColors.fuchsiaPink, fontSize: 34),
                    //            ),
                    //            TextSpan(
                    //              text: "N",
                    //              style: TextStyle(
                    //                  color: AppColors.skyColor, fontSize: 34),
                    //            ),
                    //        TextSpan(
                    // text: "Ntenatal", style: TextStyle(color: Colors.white))
                    //          ],
                    //        ),
                    //      ),
                    // const TextWidget(),
