...
class AppColors {
  ...
  static Color fuchsiaPink = const Color(0xffffc7fa);
  ...
  static Color goldenColor = const Color(0xffFFD700);
  static Color metgoldenColor = const Color(0xffAE8625);
  static Color shedowgreyColor = const Color(0xFFbfbfbf);
  static Color skyColor= const Color(0xffbefff7);
}
